                                            ...
                                            <?php
                                                ...
                                                if (count($teacherList) > 0) {
                                                    ...
                                                    foreach ($teacherList as $row) {
                                                        ...
                                                        echo "<input class='btn btn-warning mx-2 p-1 px-2' type='button' value='Assign' onclick='assignFunction({$rowNumber})'>";
                                                        echo "<input class='btn btn-primary p-1 px-2' type='button' value='Edit' onclick='editFunction({$rowNumber})'>";
                                                        echo '</div>';
