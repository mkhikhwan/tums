    ...
    if ($stmt) {
        ...
        if ($result) {
            if (mysqli_num_rows($result) > 0) {
                ...
                $image_path = '../data/img/teacher/' . $user_data['t_profilePicture'];
            } else {
                echo "";
            }
        } else {
                ...
                <nav class="navbar navbar-expand bg-white shadow mb-4 topbar static-top navbar-light">
                    <div class="container-fluid header"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button">
                        ...
                        <label class="form-label fs-3 text-nowrap" id="label_welcome">
                            <br><h4>View Profile : <span><?= $user_data['t_name']?></span></span></h4></label>
                    </div>
                </nav>
                                        ...
                                        <div class="container p-2">
                                            <div class="row m-0" id="textCont"> <!-- Alex:25/10/23: Add ID -->
                                                ...
                                                <div class="col-md-3 d-flex justify-content-center align-items-center">
                                                    <img src="<?php echo $image_path ?>" alt="Profile Picture" class="picture rounded-circle">
                                                </div>
