...
function getUserCredentialsByEmail($email) {
    ...
    $query = "SELECT t_name, t_username, t_password FROM teacher WHERE t_email = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_data !== null) {
        $result = emailAccountDetails($email, $user_data['t_name'], $user_data['t_username'], $user_data['t_password']);
