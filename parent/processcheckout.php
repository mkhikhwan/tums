...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject = "Payment Invoice " . date('Y-m-d H:i:s');
    $message = "<h2>Invoice</h2>";
    $message .= "<hr>";
    $message .= "<p><strong>Customer Name:</strong> $name</p>";
    $message .= "<p><strong>Email:</strong> $email</p>";
    $message .= "<p><strong>Contact Number:</strong> $contact</p>";
    $message .= "<p><strong>Billing Address:</strong> $address1</p>";
    $message .= "<p><strong>Postcode:</strong> $postcode</p>";
    $message .= "<p><strong>State:</strong> $state</p>";
    $message .= "<p><strong>Payment Details :<br><br></strong> $paymentdetail</p>";
    $message .= "<hr>";
    $message .= "<p><strong>Sub Total:</strong> $subTotal</p>";
    $message .= "<p><strong>Tax:</strong> $tax</p>";
    $message .= "<p><strong>Service Charge:</strong> $serviceCharge</p>";
    ...
    $headers .= "From: tums@example.com"; // Change this to your actual email address
    ...
    if ($conn) {
        ...
        if (isset($matches[1])) {
            ...
            foreach ($extracted_ids as $target_p_id) {
                $query = "UPDATE parentpayment SET p_status = 'Paid' WHERE p_id = ?";
